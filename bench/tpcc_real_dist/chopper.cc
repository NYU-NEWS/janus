...
void TpccRealDistChopper::payment_shard(const char *tb,
                                        const std::vector<Value> &input,
                                        uint32_t &site) {
  MultiValue mv;
...
void TpccRealDistChopper::order_status_shard(const char *tb,
...
void TpccRealDistChopper::delivery_shard(const char *tb,
                                         const std::vector<mdb::Value> &input,
                                         uint32_t &site,
                                         int cnt) {
  MultiValue mv;
...
void TpccRealDistChopper::stock_level_shard(const char *tb,
