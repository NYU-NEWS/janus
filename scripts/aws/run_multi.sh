...
function rw_fixed {
	...
	./run_all.py -g -hh config/aws_hosts.yml -cc config/client_closed.yml -cc /tmp/concurrent.yml -cc config/rw_fixed.yml -cc config/tpl_ww_paxos.yml -b rw_benchmark -m brq:brq -m 2pl_ww:multi_paxos -m occ:multi_paxos -m tapir:tapir -c 1 -c 2 -c 4 -c 8 -c 16 -s 1 -u 1 -r 3 -d $duration $exp_name -dc $datacenters
	new_experiment $exp_name
}

function rw {
	exp_name=${prefix}_rw
	./run_all.py -g -hh config/aws_hosts.yml -cc config/client_closed.yml -cc /tmp/concurrent.yml -cc config/rw.yml -cc config/tpl_ww_paxos.yml -b rw_benchmark -m brq:brq -m 2pl_ww:multi_paxos -m occ:multi_paxos -m tapir:tapir -c 1 -c 2 -c 4 -c 8 -c 16 -c 32 -s 1 -u 1 -r 3 -d $duration $exp_name -dc $datacenters
	new_experiment $exp_name
}
...
function zipfs {
	...
	do
		...
		./run_all.py -g -hh config/aws_hosts.yml -cc config/client_closed.yml -cc /tmp/concurrent.yml -cc config/tpca_zipf.yml -cc config/tapir.yml -b tpca -m brq:brq -m 2pl_ww:multi_paxos -m occ:multi_paxos -m tapir:tapir -c 1 -c 2 -c 4 -c 8 -c 16 -z $zipf -s 6 -u 2 -r 3 -d $duration $exp_name -dc $datacenters
		new_experiment $exp_name
	done
}
