...
./run_all.py -u 2 -hh config/aws_hosts.yml -cc config/client_closed.yml -cc config/concurrent_10.yml -cc config/tpca_fixed.yml -cc config/tapir.yml -b tpca -m brq:brq -m 2pl_ww:multi_paxos -m occ:multi_paxos -m tapir:tapir -c 1 -c 2 -c 4 -c 8 -c 16 -c 32 -c 64 -s 3 -r 3 -d $duration $exp_name
new_experiment $exp_name
...
do
	...
	./run_all.py -u 2 -hh config/aws_hosts.yml -cc config/client_closed.yml -cc config/concurrent_10.yml -cc config/tpca_zipf.yml -cc config/tapir.yml -b tpca -m brq:brq -m 2pl_ww:multi_paxos -m occ:multi_paxos -m tapir:tapir -c 1 -c 2 -c 4 -c 8 -c 16 -c 32 -c 64 -z $zipf -s 3 -r 3 -d $duration $exp_name
	new_experiment $exp_name
done
