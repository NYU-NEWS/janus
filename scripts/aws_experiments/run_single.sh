...
scripts/aws_experiments/zipf_graph.py $exp_name -c 16 -f config/tpca_zipf.yml config/tapir.yml config/concurrent_10.yml
...
#./run_all.py -hh config/aws_hosts.yml -cc config/concurrent_10.yml -cc config/tpcc.yml -cc config/tapir.yml -b tpcc -m brq:brq -m 2pl_ww:multi_paxos -m occ:multi_paxos -m tapir:tapir -c 1 -c 2 -c 4 -c 8 -c 16 -c 32 -s 3 -r 3 -d $duration $exp_name 
#new_experiment $exp_name
